...
PDF_DUMMY_URL = "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
...
async def main():
    ...
    try:
        ...
        if not condominio_id:
            ...
            if condo: condominio_id = condo.id
        ...
        docs_para_criar = [
            {"titulo": "Regulamento Interno 2026", "cat": "Regulamento", "file": "regulamento.pdf"},
            {"titulo": "Ata da Assembleia - Abr/26", "cat": "Ata", "file": "ata_abr.pdf"},
            {"titulo": "Financeiro Mensal", "cat": "Financeiro", "file": "financeiro.pdf"}
        ]
