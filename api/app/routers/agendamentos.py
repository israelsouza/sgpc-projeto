...
async def atualizar_reserva(reserva_id: int, dados: ReservaUpdate, db: Prisma = Depends(get_prisma)):
    return await AgendamentoController.atualizar_reserva(reserva_id=reserva_id, dados=dados, db=db)
